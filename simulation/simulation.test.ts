 ...
 * the full 30-journey suite alongside the unit tests.
 *
...
describe("WhatsApp feature simulation (30 journeys)", () => {
  it(
    ...
    20 * 60 * 1000, // 20 min — boots PGlite + server once, then all 30
  );
});
